...
function _generateCommonModes() {
  let code = "// ignore_for_file: prefer_single_quotes, non_constant_identifier_names\npart of 'alakon.dart';";
...
function _generateLanguageModes() {
  ...
  items.forEach(item => {
    ...
    console.log(items[0].factory)
    console.log(`generating ${item.name}`);
    let code = "// ignore_for_file: prefer_single_quotes\n";
    code+= "import 'package:re_highlight/re_highlight.dart';";
    code+="part 'modes.dart';"
    ...
    code += ';';
    _writeCode(`../lib/src/generated/${item.name}.dart`, code);
  });
}
